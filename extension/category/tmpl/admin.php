<div class="card card-default">
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-12 mt-3 mt-lg-0 text-center text-lg-left">
        ...
        <div class="row">
            <div class="col-12">
                <div class="table-responsive-lg">
                    <table class="table table-cell table-striped table-bordered wares_arrays_data" style="width:100%;background-color: #FFFFFF;">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Тип</th>
                        ...
                        if (e['data'].length > 0) {
                            for (var i = 0; i < e['data'].length; i++) {
                                $(".category_all").append('<tr>\n\
                                    <td class="text-center align-middle">' + e['data'][i]['id'] + '</td>\n\
                                    ...
                                    <td><input type="text" name="category_val" value="' + e['data'][i]['val'] + '" elm_id="' + e['data'][i]['id'] + '" elm_table="zay_category" elm_row="val" class="form-control init_elm_edit" /></td>\n\
                                    <td class="text-center align-middle"><span class="btn btn-danger init_elm_delete" elm_id="' + e['data'][i]['id'] + '" elm_table="zay_category" func="init_categories_all()"><i class="mdi mdi-delete"></i></span></td>\n\
                                </tr>');
                            }
                        }
                    }
