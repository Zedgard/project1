...
<div class="mb-3">
    <div class="mb-3 clearfix">
        ...
        <input type="checkbox" name="block_trailer" value="1" class="form-check-input float-left ml-lg-3 block_checked block_trailer_checked" block_type="block_trailer" title="Отобразить блок" /> 
    </div>
