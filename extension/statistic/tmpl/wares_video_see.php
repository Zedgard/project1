...
<div class="card card-default" id="wares-activity1">

    <div><!-- data-scroll-height="642" -->
        <div class="card-header card-header-border-bottom flex-column align-items-start">
            <h4 class="float-left">Количество просмотров видео</h4>
            <div class="date-range-report_users float-right mt-2" style="float: right;">
                <span></span>
            </div>
        ...
        <div class="card-body">
            <canvas id="wares_video_see_1" class="chartjs"></canvas>
        </div>
        <!--
...
<script>
    ...
    $(document).ready(function () {
        ...
        var cUser = document.getElementById("wares_video_see_1");
        var myUChart;
        /*======== 2. USER ACTIVITY ========*/
        if ($("#wares-activity1")) {
            ...
            var cb = function (start, end) {
                $("#wares-activity1 .date-range-report_users span").html(start.format("L") + " - " + end.format("L"));
                //console.log("start: " + start.format("L"));
                sendPostLigth('/jpost.php?extension=statistic',
                        {
                            "getWaresVideoSeeData": 1,
            ...
            $("#wares-activity1 .date-range-report_users").daterangepicker(
                    {
                        startDate: start,
                        endDate: end,
                        opens: 'left',
