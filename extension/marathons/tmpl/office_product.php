...
<div class="container-fluid">
    <!-- Большие экраны d-none d-lg-block -->
    <div class="">
            ...
            <div class="col-md mb-1">
                <div class="marathons_elm">
                    <a href="javascript:void(0)" 
                       class="d-none d-lg-block marathons_btn marathons_btn_green marathons_material_series_btn" 
                       series_id="0" 
                       elm_type="D"
                       >
                    ...
                    <a href="javascript:void(0)" 
                       class="d-block d-lg-none marathons_btn marathons_btn_green marathons_material_series_btn" 
                       series_id="0" 
                       elm_type="M"
                       >
                        <span>Общие материалы марафона</span>
