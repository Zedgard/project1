<nav class="collapse ">
    <ul class="nav nav-pills" id="mainNav">
        ...
        <li class="dropdown">
            <a class="dropdown-item dropdown-toggle" href="/shop/">Продукты<!-- &nbsp;<i class="fas fa-angle-down" style="margin-top: 4px;"></i>--></a>														
            <!--
            <ul class="dropdown-menu">
                <li class="dropdown-submenu">
        ...
        <li class="dropdown">
            <a class="dropdown-item dropdown-toggle" href="/contact/">Контакты</a>														
