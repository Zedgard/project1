...
<link rel="stylesheet" href="/assets/css/porto/css/theme-elements.css">
                ...
                <div class="header-column">
                    <div class="header-row">
                        <div class="header-logo">
                            <a href="/">
                                <img class="header_logo" data-sticky-width="82" data-sticky-height="40" src="/logo.svg">
                            </a>
                        </div>
                    </div>
                </div>
                                    ...
                                    <ul class="nav nav-pills" id="mainNav">
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li>																
                                                    <a class="dropdown-item" href="index.html#demos">Demos</a>															
                                                </li>
                            ...
                            <div class="header-nav-feature header-nav-features-cart d-inline-flex" style="float: right;">
                                ...
                                <div class="header-nav-features-dropdown" id="headerTopCartDropdown">
                                    <ol class="mini-products-list">
                                        <li class="item">
                                            <a href="#" title="Camera X1000" class="product-image"><img src="/themes/site1/images/gallery-box1.jpg" alt="Camera X1000"></a>														
                                            <div class="product-details">
                                                <p class="product-name">																<a href="#">Camera X1000 </a>															</p>
                                                <p class="qty-price">																 1X <span class="price">$890</span>															</p>
                                                <a href="#" title="Remove This Item" class="btn-remove basket_remove_item"><i class="fas fa-times"></i></a>														
                                            </div>
                                        </li>
                                    </ol>
                                    <div class="totals">	
                                        <span class="label">Сумма:</span>													<span class="price-total"><span class="price">$890</span></span>												</div>
                                    <div class="actions">		
                                        <a class="btn btn-outline-primary" href="#">В корзину</a>
                                        <a class="btn btn-outline-success" href="#">Купить</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script src="/assets/css/porto/js/theme.init.js"></script>
