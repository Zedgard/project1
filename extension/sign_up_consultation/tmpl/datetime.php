    ...
    <div date-picker
        ...
        <div class="datepicker"
            ...
            <div class="datepicker-header">
                ...
                <div style="display: none;" class="datepicker-title" ng-if="datepicker_title">{{ datepickerTitle}}</div>
                <div style="display: none;" class="datepicker-subheader">{{ customMessage}} {{ selectedDay}} {{ monthNames[localdate.getMonth()]}} {{ localdate.getDate()}}, {{ localdate.getFullYear()}}</div>
            </div>
            <div class="datepicker-calendar">
                <div class="calendar-header">
                    <div class="goback" ng-click="moveBack()" ng-if="pickdate">
                        <svg width="30" height="30">
                        <path fill="none" stroke="#00bfda" stroke-width="3" d="M19,6 l-9,9 l9,9"/>
                        </svg>
                    </div>
                    ...
                    <div class="goforward" ng-click="moveForward()" ng-if="pickdate">
                        <svg width="30" height="30">
                        <path fill="none" stroke="#00bfda" stroke-width="3" d="M11,6 l9,9 l-9,9" />
                        </svg>
                    </div>
                </div>
...
// Date Picker
    ...
    restrict: 'AE',
            ...
            scope.days = [
            { "long":"Sunday", "short":"Пн" },
            { "long":"Monday", "short":"Вт" },
            { "long":"Tuesday", "short":"Ср" },
            { "long":"Wednesday", "short":"Чт" },
            { "long":"Thursday", "short":"Пт" },
            { "long":"Friday", "short":"Сб" },
            { "long":"Saturday", "short":"Вс" },
            ];
