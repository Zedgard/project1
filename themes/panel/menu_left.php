<div class="sidebar-scrollbar" style="overflow: auto;">
    ...
    <!-- sidebar menu -->
    <ul class="nav sidebar-inner" id="sidebar-menu" style="margin: 0;padding: 0;">

        <li style="margin: 0;padding: 0;" class="has-sub <?= ($_SESSION['page_url'] == 'admin') ? 'active' : '' ?> expand" >
        ...
        if ($user->isAccess() >= 8) {
            ?>
            <li style="margin: 0;padding: 0;" class="has-sub <?= ($_SESSION['page_url'] == 'consultation_edit') ? 'active' : '' ?> ">
            ...
            <li style="margin: 0;padding: 0;" class="has-sub <?= ($_SESSION['page_url'] == 'pay') ? 'active' : '' ?> ">
            ...
            <li style="margin: 0;padding: 0;" class="has-sub <?= ($_SESSION['page_url'] == 'catalog') ? 'active' : '' ?> ">
            ...
            <li style="margin: 0;padding: 0;" class="has-sub <?= ($_SESSION['page_url'] == 'wares') ? 'active' : '' ?> ">
            ...
            <li style="margin: 0;padding: 0;" class="has-sub <?= ($_SESSION['page_url'] == 'menu') ? 'active' : '' ?> ">
            ...
            <li style="margin: 0;padding: 0;" class="has-sub <?= ($_SESSION['page_url'] == 'admin_users') ? 'active' : '' ?> ">
            ...
            <li style="margin: 0;padding: 0;" class="has-sub <?= ($_SESSION['page_url'] == 'get_emails') ? 'active' : '' ?> ">
        ...
        if ($user->isAccess() >= 8) {
            ...
            <li style="margin: 0;padding: 0;" class="has-sub" >
                ...
                <ul style="margin: 0;padding: 0;" class="collapse <?=
                (
                ...
                ?>"  id="system_configs"
                    ...
                    <div class="sub-menu">
                        ...
                        <li style="margin: 0;padding: 0;" class="<?= ($_SESSION['page_url'] == 'system_configs') ? 'active' : '' ?>">
                        ...
                        <li style="margin: 0;padding: 0;" class="<?= ($_SESSION['page_url'] == 'config_emails') ? 'active' : '' ?>" >
                            <a class="sidenav-item-link" href="/admin/config_emails/">
                                <span class="nav-text">Почтовые оповещения</span>
                            </a>
                        </li>
                        <li style="margin: 0;padding: 0;" class="<?= ($_SESSION['page_url'] == 'template') ? 'active' : '' ?>" >
                            <a class="sidenav-item-link" href="/admin/template/">
                                <span class="nav-text">Шаблоны</span>
                            </a>
                        </li>
                        <li style="margin: 0;padding: 0;" class="<?= ($_SESSION['page_url'] == 'webhook_settings') ? 'active' : '' ?>" >
                            <a class="sidenav-item-link" href="/admin/webhook_settings/">
