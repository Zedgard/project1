...
<!--Site Footer Here-->
<footer id="site-footer" class="site_footer padding_half" style="background-color: #000000;">
    <div class="container">
        <div class="row">
            <div class="col-md-4 mb-4">
                <div class="row mb-3" style="color: #bbbbbb;">
                    <div class="col-lg-12">
                ...
                <div class="row mb-2" >
                    <div class="col-lg-12">
                        <p>
                            <i class="fa fa-envelope"></i> <a href="" class="link_ed_mailto"></a>
                        </p>
                    </div>
                </div>
                <div class="row mb-2">
