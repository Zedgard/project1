...
<title><?= $_SESSION['site_title'] ?> | 404</title>
...
<header class="site-header">
   <nav class="navbar navbar-expand-lg transparent-bg static-nav">
      <div class="container">
         ...
         <img src="/themes/site1/images/logo-transparent.png" alt="logo">
         </a>
   ...
   <div class="side-menu">
      <div class="inner-wrapper">
         ...
         <p class="whitecolor">&copy; <?= date("Y") ?> XeOne. Made With Love by themesindustry</p>
         </div>
      </div>
   </div>
      ...
      <div class="row">
         <div class="col-sm-12">
            <div class="text-center">
               <h2 class="whitecolor font-light bottom30">404 страницы не существует </h2>
   ...
   <div class="container">
      <div class="row">
         ...
         <div class="col-md-6 col-sm-8 text-center">
            <div class="error wow zoomIn">
               <h1>404</h1>
               <h2>404</h2>
            </div>
            <p class="heading_space">К сожалению, нужной вам страницы здесь больше нет. Может быть, одна из ссылок ниже может помочь!</p>
            <a href="/" class="button btnprimary btn-gradient-hvr wow fadeInLeft">На главную</a>
