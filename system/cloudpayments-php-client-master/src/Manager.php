...
include_once 'Exception/BaseException.php';
include_once 'Exception/RequestException.php';
include_once 'Exception/PaymentException.php';
include_once 'Model/Transaction.php';
include_once 'Model/Required3DS.php';
...
class Manager {
    ...
    public function findPayment($invoiceId) {
        ...
        if (strlen($response['Message']) > 0) {
            $this->setMessage($response['Model']['Message']);
        }
