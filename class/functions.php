...
if (!function_exists('location_href')) {
...
if (!function_exists('init_og_meta')) {

    /**
     * Meta для копирования ссылок в социальных сетях
     * @param string $title
     * @param string $type
     * @param string $url
     * @param string $image
     ...
     */
    function init_og_meta($title = '', $image = '', $type = '', $url = '', $site_name = '') {
        if (strlen($type) == 0) {
            $type = 'website';
        }
        if (strlen($url) == 0) {
