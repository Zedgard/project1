"object" == typeof navigator && function (e, t) {
    ...
    const We = {
        ...
        inject() {
            ...
            if (Y.isEdge && K(s), this.config.tooltips.controls) {
                ...
                i = `${t.controls.wrapper} ${t.labels} .${e.hidden}`, s = ce.call(this, i);
    ...
    const Ye = {
        ...
        toggle(e, t = !0) {
            ...
            s = this.config.classNames.captions.active, n = I(e) ? !i : e;
            if (n !== i) {
    ...
    class lt {
        ...
        handleKey(e) {
            ...
            s = e.keyCode ? e.keyCode : e.which, n = "keydown" === e.type, a = n && s === this.lastKey;
            ...
            e.embed = new window.YT.Player(e.media, {
                ...
                events: {
                    ...
                    onReady(i) {
                        ...
                        e.options.speed = o.filter((t => e.config.speed.options.includes(t))), e.supported.ui && t.customControls && e.media.setAttribute("tabindex", -1), ve.call(e, e.media, "timeupdate"), ve.call(e, e.media, "durationchange"), clearInterval(e.timers.buffering), 
