            ...
            <div class="content">							
                <div class="row">
                    ...
                    <? if (!isset($_GET['registrations'])): ?>
                        <div class="col-xl-5 col-lg-6 col-md-10 offset-md-5">
                            <div class="card">
                                    ...
                                    <form action="/">
                                        <div class="row">
                                            <div class="form-group col-md-12 mb-4">
                                                <input type="login" class="form-control input-lg" id="email" aria-describedby="emailHelp" placeholder="Телефон / Эл. Почта">
                                            </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body p-5">
                                        ...
                                        <form action="/index.html">
                                            <div class="row">
                                                <div class="form-group col-md-12 mb-4">
                                                    <input type="text" class="form-control input-lg" id="phone" aria-describedby="nameHelp" placeholder="Мобильный телефон">
                                                </div>
                                                <div class="form-group col-md-12 mb-4">
                                                    <input type="email" class="form-control input-lg" id="email" aria-describedby="emailHelp" placeholder="Адрес электронной почты">
                                                </div>
                                                <div class="form-group col-md-12 ">
                                                    <input type="password" class="form-control input-lg" id="password" placeholder="Пароль">
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <p>У меня есть уже аккаунт
                                                        <a class="text-blue" href="sign-in.html">Авторизация</a>
                                                    </p>
                                                </div>
                                            </div>
                                        </form>
